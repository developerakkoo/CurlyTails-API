...
route.post(
  "/add",
  validatedData.validatePharmacy,
  PharmacyController.postPharmacy
);

route.put(
  "/add/image/:pharmacyId",
  Upload.single("file"),
  PharmacyController.updateImage
);

route.put("/update/details/:pharmacyId", PharmacyController.updatedPharmacy);

route.get("/getAll", PharmacyController.getAllPharmacy);

route.get("/get/:pharmacyId", PharmacyController.getPharmacyById);

route.delete("/delete/:pharmacyId", PharmacyController.deletePharmacy);
