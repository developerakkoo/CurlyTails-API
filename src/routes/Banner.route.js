...
route.post("/add", upload.single("file"), BannerController.addBanner);

route.get("/getAll", BannerController.getBanners);

route.get("/get/:bannerId", BannerController.getBannerById);
...
route.put("/update-Top-Trending/:bannerId", BannerController.isTopBanner);

route.delete("/delete/:bannerId", BannerController.deleteBanner);

route.get("/get-Trending", BannerController.getTrendingBanner);

route.get("/get-top", BannerController.getTopBanner);
