...
route.get("/getAll", BlogController.getAllBlogs);

route.get("/get-top", BlogController.getTopBlogs);

route.get("/get/:blogId", BlogController.getBlogById);
