...
route.post("/singUp", Validate.validateUser, UserController.postSignup);

route.post("/login", UserController.loginUser);

route.put("/update/:userId", UserController.UpdateUsers);

route.get("/getAll", UserController.getAllUsers);

route.get("/get/:userId", UserController.getUsersById);
