...
route.post("/post", validateRefund, refundController.postRefund);

route.get("/get/:refundId", refundController.getRefundRequestById);

route.get("/getAll", refundController.getAllRefundRequest);

route.put(
  "/update-status/:refundId",
  refundController.updateRefundRequestStatus
);

route.delete("/delete/:refundId", refundController.deleteRefundRequest);
