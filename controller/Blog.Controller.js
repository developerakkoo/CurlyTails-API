...
/********************************************************/   
        savedBlog.imageUrl = imageUrl!= undefined
        ? imageUrl
        :savedBlog.imageUrl 
...
exports.updateBlog= async (req, res, next) => {
    try {
        ...
        savedBlog.Title = req.body.title!= undefined
        ? req.body.title
        :savedBlog.Title 

        savedBlog.description = req.body.description != undefined
...
exports.getBlogById = async(req,res) =>{
    try {
        ...
        res.status(200).json({message:'Blog Fetched Successfully',statusCode:200,data:savedBlog});
    } catch (error) {
        res.status(500).json({message:error.message,statusCode:500,status:'ERROR'});
    }
}
